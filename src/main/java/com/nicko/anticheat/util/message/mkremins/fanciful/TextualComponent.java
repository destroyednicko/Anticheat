...
public abstract class TextualComponent implements Cloneable {
	...
	/**
	 * @return The JSON key used to represent text components of this action.
	 */
	 ...
	 * This is the default action of textual component when a single string literal is given to a method.
	 *
